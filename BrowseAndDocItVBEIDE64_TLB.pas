unit BrowseAndDocItVBEIDE64_TLB;
...
const
  ...
  BrowseAndDocItVBEIDE64MajorVersion = 1;
  BrowseAndDocItVBEIDE64MinorVersion = 0;

  LIBID_BrowseAndDocItVBEIDE64: TGUID = '{70668A3A-AC0E-49D2-83EB-A45301B8D460}';
