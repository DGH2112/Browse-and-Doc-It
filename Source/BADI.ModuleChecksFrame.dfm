object frameBADIModuleChecks: TframeBADIModuleChecks
  Left = 0
  Top = 0
  Width = 419
  Height = 344
  ...
  ParentFont = False
  TabOrder = 0
  object vstChecks: TVirtualStringTree
    ...
    OnBeforeCellPaint = vstChecksBeforeCellPaint
    OnChecked = vstChecksChecked
    OnEditing = vstChecksEditing
    OnGetText = vstChecksGetText
    OnPaintText = vstChecksPaintText
    OnHeaderClick = vstChecksHeaderClick
    OnNewText = vstChecksNewText
    Columns = <
      item
        CheckBox = True
        Position = 0
        Width = 184
        WideText = 'Module Checks'
      end
      item
        Position = 1
        Width = 150
