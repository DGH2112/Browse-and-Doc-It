...
Resourcestring
  ...
  (** This is a resource string for expected white space. **)
  strExpectedWhitespace = 'Expected white space but found ''%s'' at line %d column %d.';
  ...
  atrExpectedEndTagNamed = 'Expected end tag named ''%s'' but found ''%s'' at line %d column %d.';
  ...
  strExpectedElement = 'Expected <Element> but ''%s'' found at line %d column %d.';
  ...
  strHTMLElementLowercase = 'HTML element ''%s'' should be in lowercase at line %d column %d.';
