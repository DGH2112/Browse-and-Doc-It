  ...
  Strict Private
    Type
      ...
      TBADIMetricRecord = Record
        ...
        FText            : String;
        FImageIndex      : Integer;
        FMetrics         : Array[TBADIModuleMetric] Of Double;
        FIssueCount      : Integer;
...
Const
  ...
  MetricColumns : Array[TBADIMetricColumn] Of TMetricColumnInfo = (
...
(**
  ...
  A constructor for the TframeBADIModuleMetricsEditorView class.
