...
**)
Constructor TEidolonModule.CreateParser(Const Source, strFileName : String; Const IsModified : Boolean;
...
**)
Function TEidolonModule.GetComment(Const CommentPosition : TCommentPosition) : TComment;
