...
Begin
  {$IFDEF PROFILECODE}
  CodeProfiler.Start('TframeModuleExplorer.GetNodeComment');
  Try
  {$ENDIF}
...
begin
  {$IFDEF PROFILECODE}
  CodeProfiler.Start('TframeModuleExplorer.GetTreeNodeInfo');
  Try
  {$ENDIF}
  Result := Nil;
...
begin
  {$IFDEF PROFILECODE}
  CodeProfiler.Start('TframeModuleExplorer.tvExplorerCustomDrawItem');
  Try
  {$ENDIF}
