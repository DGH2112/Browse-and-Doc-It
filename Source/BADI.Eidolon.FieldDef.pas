...
**)
function TFieldDef.AsString(Const boolShowIdentifier, boolForDocumentation: Boolean): String;
...
**)
constructor TFieldDef.Create(const strName: String; Const AScope: TScope; Const iLine,
