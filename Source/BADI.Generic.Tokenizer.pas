...
(**
  ...
  the passed string with respect to some basic object pascal grammar.

  @precon  strText is the line of text to be tokenised
...
Const
  ...
  (**
    ...
    @precon  None.
    @postcon The current character is added to the token buffer.
  ...
  **)
  ...
  (**
    ...
    This procedures checks to see of the current character is a opening or closing brace.

    @precon  None.
    @postcon Returns the block type and current token type.
  ...
  **)
  ...
  (**
    ...
    @precon  None.
    @postcon Resets the block type of the current character is a carriage return and the block type
             is a line comment.
  ...
  **)
  ...
  (**
    ...
    This procedure checks the current and last characters in the stream to determine whether they
  ...
  **)
  ...
  (**
    ...
    @precon  None.
    @postcon Updates the token type of an XML tag if this is appropriate.
  ...
  **)
  ...
  Begin
    ...
    If strToken = '>' Then
      boolInXMLTag := False;
    If (LastToken = ttIdentifier) And (Result.Count > 1) And (Result[Result.Count - 1 - 1] = '<') And
  ...
  **)
  ...
  (**
    ...
    This function returns the token associated with the given character in the context of the
